...
get_header();
$services_meta = ! empty( interior_meta( 'service_accordions') ) ? interior_meta( 'service_accordions') : '';
$service_faqs = ! empty( interior_meta( 'service_faqs') ) ? interior_meta( 'service_faqs') : '';
$brochure = ! empty( interior_meta( 'brochure') ) ? interior_meta( 'brochure') : '';
$download_icon = INTERIOR_DIR_ICON_IMG_URI . 'download.svg';
$count = 0;
if( have_posts() ) {
                                    ...
                                    <div class="service_thumb">
                                        <?php
                                            if( $single_item['image_id'] ) {
                                                echo wp_get_attachment_image( $single_item['image_id'], 'interior_service_details_thumb_754x410', '', array('alt' => get_the_title() ) );
                                            }
                                        ?>
                                    </div>
                                </div>
