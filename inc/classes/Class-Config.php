...
final class Interior {
	...
	public function support() {
		...
		// Site logo size
		add_image_size( 'interior_site_logo_107x39', 107, 39, true );

		// Project thumb sizes
		add_image_size( 'interior_project_thumb_686x488', 686, 488, true );
		add_image_size( 'interior_project_thumb_1146x680', 1146, 680, true );

		// Latest post thumbnail size
		add_image_size( 'interior_widget_post_thumb', 80, 80, true );

		// Single blog post image size
		add_image_size( 'interior_single_blog_750x375', 750, 375, true );
		add_image_size( 'interior_np_thumb', 60, 60, true );
		...
		register_nav_menus( array(
			...
			'services'		=> esc_html__( 'Services', 'interior' ),
			'company' 		=> esc_html__( 'Company', 'interior' ),
		) );
