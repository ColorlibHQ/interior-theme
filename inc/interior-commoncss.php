...
function interior_common_custom_css(){
    ...
    wp_enqueue_style( 'interior-common', get_template_directory_uri().'/assets/css/common.css' );
		...
		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= interior_opt( 'interior_theme_color' ) != '#131313' ? interior_opt( 'interior_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= interior_opt( 'interior_book_btn_color' ) != '#131313' ? interior_opt('interior_book_btn_color') : '';
		$bookBtnHoverBgColor     	= interior_opt( 'interior_book_btn_hvr_bg_color' ) != '#131313' ? interior_opt('interior_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = interior_opt( 'interior_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = interior_opt( 'interior_navbar_bg_color' ) != '#082b49' ? interior_opt( 'interior_navbar_bg_color') : '';
		$headerTop_col     		  = interior_opt( 'interior_top_header_color' );

		$headerTopBg      		  = interior_opt( 'interior_top_header_bg_color');
		$headerBg          		  = interior_opt( 'interior_header_bg_color') != '#ffffff' ? interior_opt( 'interior_header_bg_color') : '';
		$menuColor          	  = interior_opt( 'interior_header_menu_color' ) != '#131313' ? interior_opt('interior_header_menu_color') : '';
		$menuHoverColor           = interior_opt( 'interior_header_menu_hover_color' ) != '#808080' ? interior_opt('interior_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = interior_opt( 'interior_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = interior_opt( 'interior_header_drop_menu_bg_color' ) != '#ffffff' ? interior_opt('interior_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = interior_opt( 'interior_dropdown_menu_color' ) != '#131313' ? interior_opt('interior_dropdown_menu_color') : '';
		$dropMenuHovColor         = interior_opt( 'interior_dropdown_menu_hover_color' ) != '#808080' ? interior_opt('interior_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = interior_opt( 'interior_footer_widget_bg_color' );
		$footerwHeadColor   	  = interior_opt('interior_footer_widget_heading_color');
		$footerwTextColor   	  = interior_opt('interior_footer_widget_text_color');
		$footerwanchorcolor 	  = interior_opt('interior_footer_widget_anchor_color') != '#ffffff' ? interior_opt('interior_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = interior_opt('interior_footer_widget_anchor_hover_color') != '#ffffff' ? interior_opt('interior_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = interior_opt('interior_fof_bg_color');
		$foftonecolor			  = interior_opt('interior_fof_textone_color');
		$fofttwocolor			  = interior_opt('interior_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = interior_opt('interior_footer_widget_anchor_color') != '#9e9e9e' ? interior_opt('interior_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .interior_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .interior_mailchimp_newsletter_widget button
			{
